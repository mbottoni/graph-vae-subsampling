...
from deptest.dependence import dcor_perm_test, hsic_perm_test, pearson_perm_test, whiten
from deptest.embeddings import emb_full_spectrum, emb_netlsd, emb_vgae_sv
